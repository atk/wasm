(module
  ...
  (func (export "canExecuteFastAttack") (param $knightIsAwake i32) (result i32)
    (i32.eqz (local.get $knightIsAwake))
  )
  ...
  (func (export "canSpy") (param $knightIsAwake i32) (param $archerIsAwake i32)
    ...
    (i32.or (i32.or (local.get $knightIsAwake) (local.get $archerIsAwake)) (local.get $prisonerIsAwake))
  )
  ...
  (func (export "canSignalPrisoner") (param $archerIsAwake i32) (param $prisonerIsAwake i32) (result i32)
    (i32.and (i32.eqz (local.get $archerIsAwake)) (local.get $prisonerIsAwake))
  )
  ...
  (func (export "canFreePrisoner") (param $knightIsAwake i32) (param $archerIsAwake i32)
    ...
    (i32.and (i32.eqz (local.get $archerIsAwake)) (i32.or (local.get $petDogIsPresent)
      (i32.and (i32.eqz (local.get $knightIsAwake)) (local.get $prisonerIsAwake))))
  )
)
